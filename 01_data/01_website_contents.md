...
- `#SystemsBiology`
- `#LipidResearch`
- `#EndogenousMotivation`
- `#ResearchDrivenPlatform`

---

# Core Concept

## CORE CONCEPT (이 회사의 차별점)

### Exercise Is the Switch
...
## CARD 01 — 회사의 뿌리 (절대 안 바뀌는 카드)

### NAE Platform

- Tag: `SCIENCE`
- One-liner: N-acylethanolamide biology, translated into structured performance systems.
...
## CARD 02 — PERIPHERAL PLATFORM (제품화 가능한 영역)

### Peripheral NAE Platform (OEA / PEA / SEA)

- Tag: `PLATFORM`
- One-liner: Peripheral-first lipid signaling for daily training consistency.
...
## CARD 03 — CENTRAL RESEARCH (차별점의 핵심)

### Central NAE Research (DHEA / AEA)

- Tag: `R&D`
- One-liner: Exercise-activated lipid signaling beyond the periphery.
...
## CARD 04 — EXPERIENCE (이 회사가 다른 이유)

### Training Motivation System

- Tag: `EXPERIENCE`
- One-liner: Supplementation is only one layer.
...
연구 결과, 진행 상황, 실험 데이터 → 별도 "Research Updates" 섹션

---

## Peripheral NAE Platform (상세 페이지)

상세 페이지 (개념 고정 + 내용은 업데이트)
...
- **AEA (Anandamide)**
  ...
  - Neurochemical responses to endurance activity
